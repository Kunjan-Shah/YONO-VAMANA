package com.digi.digi_vamana.vamana.model
...
object VamanaLayerRegistry {
    ...
    val layers: List<VamanaLayerInfo> = listOf(
        VamanaLayerInfo(
            ...
            description = "The moment an SMS reaches your phone, " +
                "VAMANA-Intercept's on-device classifier scores it for the phishing and " +
                "fake-APK patterns behind fraud like fake digital app scams. Instead of a " +
                "passive banner you can swipe away and forget, this educates the user on safe banking practices. " +
                "Stopping fraud here, before installation, means " +
        ...
        VamanaLayerInfo(
            ...
            title = "Isolate",
            tagline = "Runs digi-VAMANA in a sandbox nothing else can reach",
            description = "VAMANA-Isolate runs your banking session inside a separate, " +
                "isolated environment — a walled-off copy of your device that other " +
        ...
        VamanaLayerInfo(
            ...
            title = "Intelligence",
            tagline = "Learns attacker patterns to constantly evolve",
            description = "VAMANA-Intelligence fuses signals from Intercept, Isolate, and " +
                "Verify into detailed on-device logs. " +
                "When something new and genuinely " +
